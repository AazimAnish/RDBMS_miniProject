...
const ClubSection = () => {
  const clubs = [
    ...
    },
    {
      ...
      hidhead: "IEDC",
      details:
        "IEDC CUSAT is a government-funded organization that aims to promote entrepreneurship among students and young professionals in India.",
    },
    {
      id: "4",
    ...
    },
    {
      ...
      hidhead: "IEEE",
      details:
        "The IEEE Student Branch provides opportunities to meet and learn from fellow IEEE Student and Graduate Student Members and engage with professional IEEE members locally. Offering programs, activities, and professional networking opportunities that build critical skills outside of the classroom.",
    },
    {
      id: "6",
      link: "https://www.iedccusat.org/",
